...
def logo_plot(attr_df:pd.DataFrame, seq_df:pd.DataFrame, ylabel:str="", title:str="", color_scheme="dmslogo_funcgroup"):
    ...
    for i in range(len(attr_dfs)):
        ...
        if seq_i not in seqs_plotted:
            ...
            fig, axs = logo_plot(
                ...
                color_scheme=color_scheme)
            fig.savefig(f"../data/logo_plots/neg_baseline/{seq_i}.png", transparent=False)
